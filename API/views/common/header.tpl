...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/home/luiscosta/PhpstormProjects/LBAW-FEUP/public_html/css/responsive.css">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <link rel="stylesheet" type="text/css" href="../public_html/fonts/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="../public_html/fonts/font-awesome.css">
    ...
    <link rel="stylesheet" type="text/css" href="../public_html/css/wide.css">
    <link rel="stylesheet" type="text/css" href="../public_html/css/responsive.css">
    <link rel="stylesheet" type="text/css" href="../public_html/css/theme-green.css">
    <link rel="stylesheet" type="text/css" href="../public_html/css/dynamic.css">
...
<header id="site-header" class="clearfix">
    <div class="qa-navbar navbar-default navbar-fixed-top " role="navigation">
        ...
        <div class="site-logo">
            <a class="navbar-brand" title="AskMe" href="../public_html/index.php">
                <img class="navbar-site-logo" src="../public_html/img/logo.png">
            </a>
        </div>
        ...
        <div class="qa-nav-main">
            <ul class="qa-nav-main-list" style="padding-top: 6px">
                <li class="qa-nav-main-item qa-nav-main-questions">
                    <a href="../../../public_html/recent_questions.php" class="fa fa-question qa-nav-main-link" >Questions</a>
                </li>
                <li class="qa-nav-main-item qa-nav-main-unanswered">
                    <a href="/public_html/unanswered_questions.php" class="fa fa-frown-o" >Unanswered</a>
                </li>
                <li class="qa-nav-main-item qa-nav-main-tag">
                    <a href="../API/controllers/categorias.php"" class="fa fa-tags qa-nav-main-link" >Tags</a>
                </li>

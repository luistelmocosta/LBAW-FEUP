                                ...
                                <table class="qa-form-wide-table">
                                    ...
                                    <tr>
                                        <td class="qa-form-tall-data" colspan="3">
                                            <div class="qa-form-tall-image"><a href="../user/lbaw1641" class="qa-avatar-link"><img src="../public_html/img/person-flat.png" width="128" height="128" class="qa-avatar-image" alt=""></a></div>
                                        </td>
                                    </tr>
                                    </tbody>

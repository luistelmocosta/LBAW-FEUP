                    ...
                    <div class="user-header">
                        <div class="user-header-inner clearfix">
                            <div class="user-thumb">
                                <a href="./user/lbaw1641"><img src="../public_html/img/person-flat.png"></a>
                            </div>
                        ...
                        <form enctype="multipart/form-data" method="post" action="./account">
                            <table class="qa-form-wide-table">
                                ...
                                <tr>
                                    ...
                                    <td class="qa-form-wide-data">
                                        <input name="avatar" type="radio" value="" checked="" class="qa-form-wide-radio"> <span style="margin:2px 0; display:inline-block;"><img src="../public_html/img/person-flat.png" width="32" height="32" class="qa-avatar-image" alt=""></span> Default
                                        <br>

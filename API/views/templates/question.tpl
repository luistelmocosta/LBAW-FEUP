                            ...
                            <div id="question-right-position">
                                <div class="widget cs_related_questions">													<h3 class="widget-title">Related questions</h3>
                                    <div class="ra-rq-widget">
                                        <ul>
                                            <li><div class="avatar" data-id="4" data-handle="Smith"><a href="../user/Smith" class="qa-avatar-link"><img src="../public_html/img/users.jpg" width="30" height="30" class="qa-avatar-image" alt=""></a></div>
                                            ...
                                            <li><div class="avatar" data-id="30" data-handle="Multi"><a href="../user/Multi" class="qa-avatar-link"><img src="../public_html/img/users.jpg" width="30" height="30" class="qa-avatar-image" alt=""></a></div>
                                                <div class="post-content">
                                            ...
                                            <li><div class="avatar" data-id="7" data-handle="Inspector"><a href="../user/Inspector" class="qa-avatar-link"><img src="../public_html/img/users.jpg" width="30" height="30" class="qa-avatar-image" alt=""></a></div>
                                                <div class="post-content">

                    ...
                    <div class="user-header">
                        <div class="user-header-inner clearfix">
                            <div class="user-thumb">
                                <a href="../user/Digimasterbr"><img src="../public_html/img/person-flat.png"></a>
                            </div>
                                ...
                                <table class="qa-form-wide-table">
                                    ...
                                    <tr>
                                        <td class="qa-form-tall-data" colspan="3">
                                            <div class="qa-form-tall-image"><a href="../user/Digimasterbr" class="qa-avatar-link"><img src="../public_html/img/person-flat.png" width="159" height="200" class="qa-avatar-image" alt=""></a></div>
                                        </td>
                                    </tr>
                                    </tbody>

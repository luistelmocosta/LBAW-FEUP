        ...
        <div class="clearfix qa-main">
            <div class="col-sm-12 list-c">
                ...
                <div class="col-md-8">
                    ...
                    <div class = "container">
                        <ul class = "nav nav-tabs col-md-8" id = "questions" role=tablist>
                            <li class="active">
                                <a href="#1" aria-controls="" role="tab" data-toggle="tab">Recent Questions</a>
                            </li>
                            <li>
                                <a href="#2" aria-controls="" role="tab" data-toggle="tab">Unanswered Questions</a>
                            </li>
                            <li>
                                <a href="#3" aria-controls="" role="tab" data-toggle="tab">Tags</a>
                            </li>
                            <li>
                                <a href="#3" aria-controls="" role="tab" data-toggle="tab">Users</a>
                            </li>
                        </ul>


                        <div class = "tab-content" style = "margin-top: 1em;">
                            <div id ="1" role = "tabpanel" class="tab-pane fade in active">
            ...
            <span class="question-answers">2</span>
                                ...
                                <div class="question-summary narrow" id="question-summary-42479456">
                                    ...
                                    <div class="summary">
                                        <h3>
                                            <a href="" class="question-hyperlink" style="font-size: 15px; line-height: 1.4; margin-bottom: .5em;">
                                                What is the best restaurant in Oporto?
            ...
            <span class="question-updated-at">1 min ago</span>
                                        ...
                                        <span>
            <i class = "glyphicon glyphicon-comment"></i>
            <span class="question-answers">2 answers</span>
        </span>
                                    </div>
                            ...
                            <div  role = "tabpanel" class = "tab-pane fade" id ="2">
                                <div class = "row">
                                    <div class="" style = "margin-bottom:15px;">
                                        <div class = "col-sm-6 question-c-l">
                                            <h1>Hello2</h1>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="top-users-list clearfix"><li class="top-user clearfix">
                                    ...
                                    <li class="top-user clearfix">
                                        <div class="avatar" data-id="3" data-handle="HappyFace"><a href="./user/HappyFace" class="qa-avatar-link">
                                                <img src="src="../css/img/users.jpg"" width="30"

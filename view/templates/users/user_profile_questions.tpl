<div class="question-summary narrow">
    ...
    <div class="col-md-12">
        <div class="stat" style = "float: right">
            <div class="votes">
                <div class="votes-count"><span title="7 votes">
            ...
            {/if}
                ...
                <div class="answers-count"><span title="answers">{$question['answers_count']}</span></div>
                <div>answer</div>
            </div>

            <div class="views">
                <div class="views-count"><span title="views">{$question['views_counter']}</span></div>
                <div>views</div>
            </div>
        </div>
